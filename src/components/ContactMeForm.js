        ...
        <div id="contactForm" className="jumbotron">
            <div className="jumbotron-info">
                ...
                <form id="form" name="form">
                    ...
                    pattern="[a-zA-Z]{2,} [a-zA-Z]{2,}"></input>
                    <input id="company" name="company" type="text" placeholder="Company" required></input>
                    <input id="email" name="email" type="email" placeholder="E-Mail" required
                        pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$"></input>

                    <textarea id="message" name="message" type="text" placeholder="Message"></textarea>
                    <input id="submit" name="submit" type="submit" value="Send!" onClick={OnSubmitForm}></input>
                </form>
            </div>
        </div>  
    );
